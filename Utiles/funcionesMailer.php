...
function enviarMail ($data) {
    ...
    try {
        ...
        $mail->Port = 465; //establecer un puerto para que el protocolo SMTP opere con Capa de sockets seguros (SSL)
                    ...
                    <div class='containerFull'>
                        ...
                        <div class='containerText'><h1 class='h1'>Pedido recibido!</h1>
                            ...
                            <div class='containerRedes'>
                                ...
                                <a
                                    href='http://localhost/GitHub/Bach/Vista/listaCompras.php'
                    ...
                    <div class='containerFull'>
                        ...
                        <div class='containerText'><h1 class='h1'>Pedido aceptado!</h1>
                            ...
                            <div class='containerRedes'>
                                ...
                                <a  href='http://localhost/GitHub/Bach/Vista/Cliente/listaCompras.php' target='_blank'><button class='hvr-overline-from-center' >Click aquí!</button></a>
                            </div>
                        </div>
                    </body>
                </html>";
                    ...
                    <div class='containerFull'>
                        ...
                        <div class='containerText'><h1 class='h1'>Pedido enviado!</h1>
                            ...
                            <div class='containerRedes'>
                                ...
                                <a
                                    href='http://localhost/GitHub/Bach/Vista/productos.php'
                                    target='_blank'><button class='hvr-overline-from-center'>Click
                                        aquí!</button></a>
                            </div>
                        </div>
                ...
                <body class='bodyCont'>
                    <div class='containerFull'>
                        ...
                        <div class='containerText'><h1 class='h1'>Pedido cancelado</h1>
                            ...
                            <div class='containerRedes'>
                                <h3 class='h3 subtitleRedes'>Volvé a comprar con nosotros!</h3>
                                <a  href='http://localhost/GitHub/Bach/Vista/productos.php' target='_blank'><button class='hvr-overline-from-center' >Click aquí!</button></a>
                            </div>
                        </div>
                    </body>
                </html>";
